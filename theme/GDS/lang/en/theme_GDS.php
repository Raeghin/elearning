...
/* Core */
$string['configtitle'] = 'GDS';
$string['pluginname'] = 'GDS';
$string['choosereadme'] = '
<div class="clearfix">
<div class="well">
<h2>Essential</h2>
...
<div class="well">
<h3>About GDS</h3>
<p>GDS theme is based on Essential which itself is based upon the Bootstrap theme, which was created for Moodle 2.5, with the help of:<br>
