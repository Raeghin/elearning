...
// Capabilites
$string['dedication:addinstance'] = 'Toevoegen van dit blok toestaan';
$string['dedication:use'] = 'Toestaan van het blok Cursusinzet';

// Block content
$string['dedication_estimation'] = 'Tijd gespendeerd in de cursus';
$string['access_button'] = 'Cursus inzet';
$string['access_info'] = 'Enkel voor docent:';

// Block form
$string['show_dedication'] = 'Laat gespendeerde tijd aan studenten zien.';
$string['show_dedication_help'] = 'Standaard wordt de tijd enkel aan de docenten getoond. Deze optie geeft cursisten de mogelijkheid hun tijd in te zien.';
...
// Rows
$string['dedicationrow'] = 'Cursus inzet';
...
$string['totaldedication'] = 'Totale tijd gespendeerd in de cursus: {$a}';
$string['meandedication'] = 'Gemiddelde tijd per sessie: {$a}';

// Actions
// all action
$string['dedicationall'] = 'Cursus inzet van alle cursusisten. Klik op een naam voor een gedetailleerd rapport.';
// group action
$string['dedicationgroup'] = 'Cursus inzet van alle groeps leden van de groep {$a}. Klik op een naam voor een gedetailleerd rapport.';
// user action
$string['userdedication'] = 'Gedetailleerd rapport van {$a}.';
