...
$pdf->SetTitle ( get_string ( 'report_d', 'block_ccv' ) );
$pdf->SetSubject ( get_string ( 'report_d', 'block_ccv'  ) );
...
<p><h1>' . get_string ( 'report_d', 'block_ccv' ) . '</h1></p>

<table class="tg" style="undefined;table-layout: fixed; width: 522px">

  <tr>
    <td class="tg-yw4l">' . get_string ( 'report_name' , 'block_ccv' ).'<br></td>
    <td class="tg-yw4l">' . get_string ( 'report_d', 'block_ccv' ) .'</td>
  </tr>
  <tr>
    <td class="tg-b7b8">&nbsp;<br></td>
    <td class="tg-b7b8">' . get_string ( 'report_d_text', 'block_ccv' ) .'</td>
  </tr>
  <tr>
...
<table class="tg" style="undefined;table-layout: fixed">
  <tr>
    ...
    <th width="300px" class="tg-9hbo">'.get_string ( 'not_finished_header', 'block_ccv' ).'</th>
   </tr>';
