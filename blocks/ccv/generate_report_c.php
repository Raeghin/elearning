...
$pdf->SetTitle ( get_string ( 'report_c', 'block_ccv' ) );
$pdf->SetSubject ( get_string ( 'report_c', 'block_ccv'  ) );
...
$sql = "SELECT u.id, u.firstname, u.lastname, 'none' as none
	FROM {user} u
...
<p><h1>' . get_string ( 'report_c', 'block_ccv' ) . '</h1></p>

<table class="tg" style="undefined;table-layout: fixed; width: 522px">

  <tr>
    <td class="tg-yw4l">' . get_string ( 'report_name' , 'block_ccv' ).'<br></td>
    <td class="tg-yw4l">' . get_string ( 'report_c', 'block_ccv' ) .'</td>
  </tr>
  <tr>
    <td class="tg-b7b8">&nbsp;<br></td>
    <td class="tg-b7b8">' . get_string ( 'report_c_text', 'block_ccv' ) .'</td>
  </tr>
  <tr>
...
<table class="tg" style="undefined;table-layout: fixed">
  <tr>
    ...
    <th width="300px" class="tg-9hbo">'.get_string ( 'remarkable_login', 'block_ccv' ).'</th>
   </tr>';
	...
	foreach ( $userrecords as $record ) {
		...
		$output .= '<tr>
		   	...
		   	<td class="'.$color.'">'. get_string($record->none) .'<br></td>
		   </tr>';
	}
	$output .= '</table>';
