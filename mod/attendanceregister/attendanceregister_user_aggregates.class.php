...
class attendanceregister_user_aggregates  {
    ...
    public function html_table() {
        ...
        // Header
        $table->head[] =  get_string('summary', 'attendanceregister');
		...
		*/
        ...
        $labelCell = new html_table_cell();
        $labelCell->colspan = 2;
        $labelCell->text = get_string('course');
        $row->cells[] = $labelCell;
        $valueCell = new html_table_cell();
        $valueCell->text = $this->course->shortname;
        $row->cells[] = $valueCell;
        $table->data[] = $row;
        ...
        $labelCell = new html_table_cell();
        $labelCell->colspan = 2;
        $labelCell->text = get_string('user');
        $row->cells[] = $labelCell;
        $valueCell = new html_table_cell();
        $valueCell->text = $this->user->firstname . " " . $this->user->lastname;
        $row->cells[] = $valueCell;
        $table->data[] = $row;
