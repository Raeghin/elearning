...
$string['assigncredits'] = 'Gebruikersbeheer';
...
$string['creditsuccess'] = 'Uw betaling is succesvol ontvangen. Uw credits zijn toegevoegd aan uw account!';
$string['firstname'] = 'Voornaam';
$string['lastname'] = 'Achternaam';
$string['email'] = 'Email';
$string['submit'] = 'toevoegen';
$string['titleadduser'] = 'Gebruiker toevoegen';
$string['emailtaken'] = 'Email in gebruik';
$string['usercreated'] = 'Gebruiker aangemaakt. Het wachtwoord voor deze gebruiker is:';
$string['titleuseroverview'] = 'Gebruikers overzicht';
$string['username'] = 'Gebruikersnaam';
$string['titleuserassign'] = 'Gebruiker toewijzen';
$string['manageusers'] = 'Gebruikers beheren';
$string['usecourse'] = 'Gebruikers toevoegen';
$string['coursename'] = 'Cursusnaam';
$string['shortname'] = 'Cursus code';
$string['editcourse'] = 'Gebruikers toevoegen';
$string['summary'] = 'Samenvatting';
$string['course'] = 'Cursus';
$string['assignedusers'] = 'Aangemelde (actieve) gebruikers';
$string['timestart'] = 'Startdatum';
$string['timeend'] = 'Einddatum';
$string['insufficientcredits'] = 'Krediet ontoereikend';